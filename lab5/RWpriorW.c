/* Prioridade para escritores: quando um escritor desejar escrever, nenhum leitor
pode iniciar uma leitura enquanto o escritor nao for atendido. Nesta solucao,
um leitor pode ter de esperar por muito tempo (inanicao), caso novos escritores
cheguem com frequencia.
*/
...
void FimEscr (int id) {
  ...
  if (qntdEscr == 0) { //prossegue se todos escritores ja foram atendidos ou ainda nao ha nenhum para ser atendido
